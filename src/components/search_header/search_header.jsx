    ...
    return (
        <header className={styles.header}>
            <div className={styles.start}>
                ...
                <span className={styles.youtube} onClick={props.LogoClick}>
            ...
            <div className={styles.center}>
               ...
               <img className={styles.searchIcon} src="/images/search.png" alt="searchImg"/>    
               </button>
               <img className={styles.microphoneImg} src="/images/microphone.png" alt="microphoneImg"/>
            </div>
